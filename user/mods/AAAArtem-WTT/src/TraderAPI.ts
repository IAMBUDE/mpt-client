...
export class TraderAPI
{
    ...
    public preSptLoad(Instance: WTTInstanceManager): void
    {
        ...
        const traderConfig = this.instanceManager.configServer.getConfig<ITraderConfig>(ConfigTypes.TRADER);
        traderConfig.moddedTraders.clothingService.push("66bf757f27d0b097db0acea5");
    }
    ...
    private registerProfileImage(trader: string, baseJson: any): void 
    {
        ...
        this.instanceManager.imageRouter.addRoute(baseJson.avatar.replace(".jpg", ""), `${imageFilepath}/${trader}.jpg`);
    }
